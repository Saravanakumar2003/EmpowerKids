...
const NewComplaintForm = ({ currUser, myinfo, notify }) => {
    ...
    const registerComplaint = async () => {
        ...
        try {
            await addDoc(collection(db, "empowerkids_complaint"),
                {
                    ...newComplaint
                });
            setComplaintInfo({
                        ...
                        <Grid item xs={12}>
                            <FormControl fullWidth>
                                ...
                                >
                                    ...
                                    <MenuItem value={"Child Marriage"}>Child Marriage</MenuItem>
                                    <MenuItem value={"Basic Rights Voilation"}>Basic Rights Voilation</MenuItem>
                                    <MenuItem value={"Cyber Issue"}>Cyber Issue</MenuItem>
                                    <MenuItem value={"Bullying"}>Bullying</MenuItem>
                                    <MenuItem value={"Caste & Racial Discrimination"}>Caste & Racial Discrimination</MenuItem>
